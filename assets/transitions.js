...
(function () {
  ...
  style.textContent = [
    ...
    /* Peek — locked at bottom of viewport once revealed.
       Constrained to the same visual slot as .essay-index .ei-inner. */
    '#tw-peek {',
    '  position: fixed;',
    '  bottom: 0;',
    '  left: 50%;',
    ...
    '}',
    /* Sweep — breaks out of the constrained slot and covers the viewport */
    ...
    '  #tw-peek { padding: 0 12px; }',
    '}',

    /* Feature image — full width of peek at rest, no scaling on hover
       (hover has no state change on the peek itself). */
    '#tw-peek-bg {',
    '  position: absolute;',
    '  top: 0;',
    '  left: 0;',
