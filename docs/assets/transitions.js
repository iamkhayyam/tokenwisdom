...
(function () {
  ...
  style.textContent = [
    ...
    /* Match .essay-index .ei-inner: max-width 1080px, 40px side padding,
       centered — so the peek strip and the progress bar occupy the same
       visual "slot", making the 95% swap read as a clean handoff. */
    '#tw-peek {',
    '  position: relative;',
    '  height: ' + PEEK_SLIM + 'px;',
    '  overflow: hidden;',
